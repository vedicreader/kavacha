...
# %% ../nbs/04_window.ipynb #38f4edbe
import os, sys, threading, time

# %% ../nbs/04_window.ipynb #3c100667
from fastcore.all import Path

# %% ../nbs/04_window.ipynb #d77be4b3
from fastcore.xdg import xdg_config_home

# %% ../nbs/04_window.ipynb #e4747194
...
# %% ../nbs/04_window.ipynb #e8f79b3d
CFG = Path(os.environ.get('KAVACHA_CFG') or xdg_config_home()/APP_NAME)

# %% ../nbs/04_window.ipynb #b50f56ce
def errstr(e): return f"{type(e).__name__}: {e}"

# %% ../nbs/04_window.ipynb #0268ad0e
BACKENDS = {'darwin': 'cocoa', 'win32': 'edgechromium', 'linux': 'gtk'}

# %% ../nbs/04_window.ipynb #a5aac9ce
DEFAULT_SIZE = (1440, 900)

# %% ../nbs/04_window.ipynb #fd87487e
MIN_SIZE = (900, 560)

# %% ../nbs/04_window.ipynb #539f0969
STORAGE = CFG/'webview'

# %% ../nbs/04_window.ipynb #72a9796a
EAGER_CDP = 'KAVACHA_CDP_EAGER'

# %% ../nbs/04_window.ipynb #71e7701f
class ShellApi:
...
# %% ../nbs/04_window.ipynb #5b7f8d28
DOCK_RECENT = 8          #: rows on the Dock menu, which is a shortcut and not a file browser

# %% ../nbs/04_window.ipynb #af5eb372
_dock_target = None

# %% ../nbs/04_window.ipynb #f3cfb925
...
# %% ../nbs/04_window.ipynb #563520dd
_hidden, _on_folder, _delegates = [], None, None

# %% ../nbs/04_window.ipynb #4cbdaa1b
def _dock_delegates():
...
# %% ../nbs/04_window.ipynb #f06cccd1
_menu_patched = False

# %% ../nbs/04_window.ipynb #dcbb45d4
